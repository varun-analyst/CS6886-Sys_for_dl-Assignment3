...
class CIFAR100Policy(object):
    ...
    def __init__(self, fillcolor=(128, 128, 128)):
        self.policies = [
            SubPolicy(0.1, "invert", 3, 0.2, "contrast", 8, fillcolor),
            SubPolicy(0.7, "rotate", 2, 0.3, "translateX", 9, fillcolor),
            SubPolicy(0.8, "sharpness", 1, 0.9, "sharpness", 3, fillcolor),
            SubPolicy(0.5, "shearY", 8, 0.7, "translateY", 9, fillcolor),
            SubPolicy(0.5, "autocontrast", 8, 0.9, "equalize", 2, fillcolor),
...
def get_cifar100(batchsize=128):
    # CIFAR-100 normalization stats (mean/std per channel)
    ...
    trans_t = transforms.Compose([
        ...
        transforms.RandomHorizontalFlip(),
        CIFAR100Policy(),       # Use CIFAR100Policy here
        transforms.ToTensor(),
    ...
    train_data = torchvision.datasets.CIFAR100('./data', train=True, transform=trans_t, download=True)
